...
const BullenList = () => {
  ...
  const handleViewLedger = (bullenName) => {
    navigate(`/regular-billing/bullen-ledger/${encodeURIComponent(bullenName)}`);
  };
  ...
  return (
    ...
    <div className="bg-white rounded-lg shadow-lg p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          onClick={() => navigate('/regular/bullen')}
      ...
      <div className="mb-6">
        <input
          ...
          className="w-full max-w-md px-4 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500"
        />
      </div>
